    ...
    if (btOn == "home") {
            ...
            <div className="Sidebar p-3 text-white d-flex flex-column flex-shrink-0">
                ...
                <ul className="nav nav-pills flex-column mb-auto">
                    <li className="nav-item">
                        <a href='/' className="nav-link text-white active" aria-current="page">Início</a>

                    </li>

                    <li>
                        <a href='/login' className="nav-link text-white" aria-current="page">Painel de Administração</a>
                    </li>
                </ul>
            </div>
        )
        ...
        return (
            <div className="Sidebar p-3 text-white d-flex flex-column flex-shrink-0">
                ...
                <div>
                    <a href="/login" className="btn btn-danger" >Sair</a>
                </div>
